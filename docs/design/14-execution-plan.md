...
| 9 | Benchmark harness + 0.1 | 0.1 | ✅ **v0.1.0 RELEASED** (all 11 crates on crates.io, tag v0.1.0) · criterion numbers in PERF.md | criterion suite live (`just bench` → benches/PERF.md): cache-hit read 39ns (25× under budget) · durable append 39µs w/ fsync · 1M fold 334µs (30× under) · resolve 7.4ns · query slice 624ns–30µs — handoff study moves to 0.1.x (needs provider decision); socket p50 ✅ (323µs); loom/crash ✅ (CP-5 row); claim + release ✅ |
