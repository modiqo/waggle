...
import ee from "./39687a18a0b871bf63a65b2fe3e74e21cf88d04d-index_bg.wasm";
...
var R = class {
  ...
  webSocketClose(e, t, n, _) {
    if (this.__wbg_inst !== void 0 && this.__wbg_inst !== o) throw new Error("Invalid stale object from previous Wasm instance");
    let a = v(n, i.__wbindgen_malloc, i.__wbindgen_realloc), f = l, u;
    c();
    try {
      u = i.hive_webSocketClose(this.__wbg_ptr, e, t, a, f, _);
    } catch (w) {
      s(w);
    }
    return u;
...
function T() {
  o++, m = null, k = null, A = null, typeof numBytesDecoded < "u" && (numBytesDecoded = 0), typeof l < "u" && (l = 0), V = false, M = false, N = new WebAssembly.Instance(ee, _e()), i = N.exports, i.__wbindgen_start();
}
__name(T, "T");
function te() {
  let r3;
...
function _e() {
  return { __proto__: null, "./index_bg.js": { __proto__: null, __wbg_Error_92b29b0548f8b746: /* @__PURE__ */ __name(function(e, t) {
    ...
    let n = String(t), _ = v(n, i.__wbindgen_malloc, i.__wbindgen_realloc), a = l;
    g().setInt32(e + 4, a, true), g().setInt32(e + 0, _, true);
    ...
    let n = D(t), _ = v(n, i.__wbindgen_malloc, i.__wbindgen_realloc), a = l;
    g().setInt32(e + 4, a, true), g().setInt32(e + 0, _, true);
    ...
    g().setFloat64(e + 8, b(_) ? 0 : _, true), g().setInt32(e + 0, !b(_), true);
    ...
    var a = b(_) ? 0 : v(_, i.__wbindgen_malloc, i.__wbindgen_realloc), f = l;
    g().setInt32(e + 4, f, true), g().setInt32(e + 0, a, true);
  }, "__wbg___wbindgen_string_get_b0ca35b86a603356"), __wbg___wbindgen_throw_344f42d3211c4765: /* @__PURE__ */ __name(function(e, t) {
    throw new WebAssembly.Exception(q, [new Error(d(e, t))]);
    ...
    console.error(e, t);
  }, "__wbg_error_7ed559cd7146b49d"), __wbg_fetch_a730576a617dd701: /* @__PURE__ */ __name(function(e, t) {
    return e.fetch(t);
    ...
    let a = t.get(d(n, _));
    var f = b(a) ? 0 : v(a, i.__wbindgen_malloc, i.__wbindgen_realloc), u = l;
    g().setInt32(e + 4, u, true), g().setInt32(e + 0, f, true);
  }, "__wbg_get_18e0163e38e5048d"), __wbg_get_395ac2273ef59cb0: /* @__PURE__ */ __name(function(e, t, n, _) {
    let a, f;
    try {
      return a = t, f = n, e.get(d(t, n), _);
    } finally {
      c();
      try {
    ...
    let n = t.method, _ = v(n, i.__wbindgen_malloc, i.__wbindgen_realloc), a = l;
    g().setInt32(e + 4, a, true), g().setInt32(e + 0, _, true);
    ...
    return new Headers();
  }, "__wbg_new_0d809930cd1354c6"), __wbg_new_32b398fb48b6d94a: /* @__PURE__ */ __name(function() {
    return new Array();
    ...
    let n = t.url, _ = v(n, i.__wbindgen_malloc, i.__wbindgen_realloc), a = l;
    g().setInt32(e + 4, a, true), g().setInt32(e + 0, _, true);
...
__name(ae, "ae");
var fe = ["bytes"];
var ue = ["default", "no-store", "reload", "no-cache", "force-cache", "only-if-cached"];
var be = ["follow", "error", "manual"];
var o = 0;
...
function v(r3, e, t) {
  if (t === void 0) {
    let u = O.encode(r3), w = e(u.length, 1) >>> 0;
    return z().subarray(w, w + u.length).set(u), l = u.length, w;
  }
  let n = r3.length, _ = e(n, 1) >>> 0, a = z(), f = 0;
  for (; f < n; f++) {
    let u = r3.charCodeAt(f);
    if (u > 127) break;
    a[_ + f] = u;
  }
  if (f !== n) {
    f !== 0 && (r3 = r3.slice(f)), _ = t(_, n, n = f + r3.length * 3, 1) >>> 0;
    let u = z().subarray(_ + f, _ + n), w = O.encodeInto(r3, u);
    f += w.written, _ = t(_, n, f, 1) >>> 0;
  }
  return l = f, _;
}
__name(v, "v");
...
function J(r3) {
  r3 instanceof WebAssembly.RuntimeError && (console.error("Critical", r3), p.criticalError = true);
}
__name(J, "J");
...
var y = { construct(r3, e, t) {
  try {
    H();
    let n = { instance: Reflect.construct(r3, e, t), instanceId: p.instanceId, ctor: r3, args: e, newTarget: t };
    return new Proxy(n, { ...Ie, get(_, a, f) {
      ...
      let u = Reflect.get(_.instance, a, f);
      return typeof u != "function" ? u : u.constructor === Function ? new Proxy(u, { apply(w, U, C) {
        H();
        try {
          return w.apply(U, C);
        } catch (W) {
      ...
      } }) : new Proxy(u, { async apply(w, U, C) {
        H();
        try {
          return await w.apply(U, C);
        } catch (W) {
          throw J(W), W;
        }
      } });
...
var je = new Proxy(P, y);
var We = new Proxy(E, y);
var ke = new Proxy(R, y);
var Ae = new Proxy(F, y);
var ze = new Proxy(S, y);
var Oe = new Proxy(x, y);
var Pe = new Proxy(I, y);
var Te = new Proxy(j, y);
...
// .wrangler/tmp/bundle-5ZHqnd/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-5ZHqnd/middleware-loader.entry.ts
